...
public class QuoteController {
    ...
    public ResponseEntity<?> generatePDF(@PathVariable Long id, @RequestBody SellerEntity seller) {
        ...
        try {
            ...
            String instalation = quoteService.instalation(quoteEntities);
    ...
    */
    ...
    public ResponseEntity<?> generatePDF(@PathVariable Long id, @RequestBody SellerEntity seller) {
        ...
        //System.out.println("REVISANDO quoteSummaryEntity: ");
        //System.out.println(quoteSummaryEntity); 


        quoteEntities = quoteService.lastQuotes(quoteSummaryEntity.getQuoteSummaryID());
        
        //System.out.println("REVISANDO QUOTE ENTITIES: ");
        ...
        try {
            ...
            System.out.println("REVISANDO QUOTE: ");
